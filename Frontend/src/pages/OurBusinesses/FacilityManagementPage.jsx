...
const FacilityManagementPage = () => {
  const images = [
    ...
    },
    {
      ...
      alt: "Hotel Guest Suite"
    },
    {
      src: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?auto=format&fit=crop&w=800&q=80",
      alt: "Resort Lounge & Pool Area"
    },
    {
    ...
    },
    {
      ...
      alt: "Commercial Building Glass Exterior"
    },
    {
      ...
      <section className="relative overflow-hidden py-20 lg:py-28 bg-gradient-to-b from-slate-50 via-slate-100/50 to-white border-b border-slate-100">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          ...
          <p className="max-w-3xl mx-auto text-lg lg:text-xl text-slate-600 leading-relaxed">
            Expanding horizons into high-end accommodations through strategic partnerships in East India's primary commercial hub.
          </p>
        </div>
      </section>
